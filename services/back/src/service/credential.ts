...
import { credentialEmailTable } from "../schema.js";
...
function _getTypeFromEmail(_email: string): WebDomainType {
...
function _buildEmailCredential(email: string, sk: SecretKey): Credential {
